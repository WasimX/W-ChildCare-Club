									...
									<tbody>
										...
										<tr>
											<td>
												...
												<h2><a href="profile.html">Lesley Grauer <span>Team Leader</span></a></h2>
											</td>
											<td>FT-0008</td>
										...
										<tr>
											<td>
												<a href="profile.html" class="avatar">J</a>
												<h2><a href="profile.html">Jeffery Lalor <span>Team Leader</span></a></h2>
											</td>
											<td>FT-0009</td>
										...
										<tr>
											<td>
												<a href="profile.html" class="avatar">L</a>
												<h2><a href="profile.html">Loren Gatlin <span>Android Developer</span></a></h2>
											</td>
											<td>FT-0010</td>
										...
										<tr>
											<td>
												...
												<h2><a href="profile.html">Tarah Shropshire <span>Android Developer</span></a></h2>
											</td>
											<td>FT-0011</td>
...
if ( isset( $_POST[ 'submit' ] ) ) {
	...
	$result = mysqli_query( $connection, "INSERT INTO `salary_m` ( `ID`, `management_ID`, `hours`, `tdate`, `method`, `period`, `overtime`, `NI`) VALUES ('', '$management', '$hours', '$date', '$method',`$period`,`$ovetime`,`$NI`)" )or die( mysqli_error( $connection ) );
								...
								<div class="row"> 
									...
									<?php while ( $row = mysqli_fetch_array( $result ) ) { ?>
										<div class="form-group">
											...
											<select class="select"> 
												<option><?php $row[ 'management_ID' ] ?> </option>
											</select>
										</div>
										<?php }} ?>
									</div>
